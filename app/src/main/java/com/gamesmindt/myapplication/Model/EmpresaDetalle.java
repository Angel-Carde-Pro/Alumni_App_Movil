...
public class EmpresaDetalle {
    ...
    public EmpresaDetalle(Integer id, Empresario empresario, Ciudad ciudad, SectorEmpresarial sectorEmpresarial, String ruc, String nombre, String tipoEmpresa, String razonSocial, String area, String sitioWeb, String estado, String ubicacion) {
        this.id = id;
